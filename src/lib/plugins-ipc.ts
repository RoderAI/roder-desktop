...
export const pluginsIpc = {
  ...
  installDefaultMarketplaces: (selection: DefaultMarketplaceSelection) =>
    window.roderDesktop.request("marketplaces/install_default", { selection }) as Promise<MarketplacesInstallDefaultResult>,
  ...
  searchMarketplacePlugins: (query?: string) => {
    ...
    return window.roderDesktop.request("marketplaces/search", trimmed ? { query: trimmed } : {}) as Promise<MarketplacesSearchResult>;
  },
  ...
  previewInstallPlugin: (marketplaceId: string, pluginId: string) =>
    window.roderDesktop.request("plugins/preview_install", { marketplaceId, pluginId }) as Promise<PluginPreviewInstallResult>,
  ...
  installAllPluginVariants: (marketplaceId: string, pluginId: string) =>
    window.roderDesktop.request("plugins/install_all_variants", { marketplaceId, pluginId }) as Promise<PluginInstallAllVariantsResult>,
  listInstalledPlugins: () => window.roderDesktop.request("plugins/list_installed", {}) as Promise<PluginListInstalledResult>,
